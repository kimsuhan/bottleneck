var Bottleneck, DEFAULT_PRIORITY, Events, Job, LocalDatastore, NUM_PRIORITIES, Queues, RedisDatastore, Scripts, States, Sync, parser,
  splice = [].splice;
...
Bottleneck = (function() {
  class Bottleneck {
    ...
    channel() {
      return Scripts.channel(this.id);
    }

    channel_client() {
      return Scripts.channelClient(this.id, this._store.clientId);
    }
